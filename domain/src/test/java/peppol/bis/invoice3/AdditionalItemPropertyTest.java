...
class AdditionalItemPropertyTest {
    ...
    void to_xml_basic_elements() {
        final Element element = (Element) additionalItemProperty.node();
        assertElementNameIs(element, "AdditionalItemProperty", CAC_NS);

        assertRequiredElement(element, "Name", equalTo("key"));
        assertRequiredElement(element, "Value", equalTo("val"));
    }
}
