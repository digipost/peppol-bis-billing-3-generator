...
class BuyersItemIdentificationTest {
    ...
    void to_xml_basic_elements() {
        final Element element = (Element) buyersItemIdentification.node();
        assertElementNameIs(element, "BuyersItemIdentification", CAC_NS);
