...
class FinancialInstitutionBranchTest {
    ...
    void to_xml_basic_elements() {
        final Element element = (Element) financialInstitutionBranch.node();
        assertElementNameIs(element, "FinancialInstitutionBranch", CAC_NS);

        assertRequiredElement(element, "ID", equalTo("9999"));
    }
}
