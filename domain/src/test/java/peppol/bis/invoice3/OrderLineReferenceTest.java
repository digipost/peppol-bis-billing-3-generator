...
public class OrderLineReferenceTest {
    ...
    void to_xml_basic_elements() {
        final Element element = (Element) orderLineReference.node();
        assertElementNameIs(element, "OrderLineReference", CAC_NS);

        assertRequiredElement(element, "LineID", equalTo("foo12"));
    }
