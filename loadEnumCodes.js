...
async function loadMetadata(url, prefix, fileName) {
    try {
        ...
        divs.each((index, element) => {
            ...
            codeMetadata.enumChain += `  ${prefix}${codeText.replaceAll("-", "_")}("${codeText}")${index === divs.length - 1 ? ';' : ','}\n`;
...
async function writeMetaData(codeMetaData) {
    ...
    enumClassContent += `public enum ${codeMetaData.fileName} implements PeppolCode {\n` +
        codeMetaData.enumChain +
        "\n}\n";
