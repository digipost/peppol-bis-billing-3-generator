...
public class CommodityClassificationTest {
    ...
    void to_xml_basic_elements() {
        final Element element = (Element) commodityClassification.node();
        assertElementNameIs(element, "CommodityClassification", CAC_NS);
