...
public class DeliveryLocationTest {
    ...
    void to_xml_required_elements() {
        ...
        assertElementNameIs(element, "DeliveryLocation", CAC_NS);

        assertUnsetOptionalElement(element, "ID");
        assertUnsetOptionalElement(element, "Address");
    }
    ...
    void to_xml_optional_elements() {
        ...
        assertRequiredElement(element, "ID", equalTo("0080"));
        assertRequiredElement(element, "Address");
    }
}
