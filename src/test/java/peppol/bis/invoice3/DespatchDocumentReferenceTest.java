...
class DespatchDocumentReferenceTest {
    ...
    void to_xml_basic_elements() {
        final Element element = (Element) despatchDocumentReference.node();
        assertElementNameIs(element, "DespatchDocumentReference", CAC_NS);

        assertRequiredElement(element, "ID", equalTo("desp98"));
    }
}
