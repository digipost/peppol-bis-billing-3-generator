...
public class ExternalReferenceTest {
    ...
    void to_xml_required_elements() {
        final Element element = (Element) externalReference.node();
        assertElementNameIs(element, "ExternalReference", CAC_NS);

        assertRequiredElement(element, "URI", equalTo("http://www.example.com/index.html"));
    }
