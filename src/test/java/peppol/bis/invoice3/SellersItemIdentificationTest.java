...
class SellersItemIdentificationTest {
    ...
    void to_xml_basic_elements() {
        final Element element = (Element) sellersItemIdentification.node();
        assertElementNameIs(element, "SellersItemIdentification", CAC_NS);
